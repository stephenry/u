...
For modern processes, wire-delays cannot be ignored. In their absence, the final computed critical-path is an under-estimate of the true path in silicon. Similarly, raw-cell area does not consider area growth due to wiring congestion and/or routability and therefore also results in a underestimate of the true silicon area. A wire limited, serial design such as 'c' may thereore compare favourably in terms of area to a wire dominant design such as 'u'. 
