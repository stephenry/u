...
For modern processes, wire-delays cannot be ignored. In their absence, the final computed critical-path is an under-estimate of the true path in silicon. Area is similarly underestimated as raw-cell area does not consider area growth due to wiring congestion or routability. 
